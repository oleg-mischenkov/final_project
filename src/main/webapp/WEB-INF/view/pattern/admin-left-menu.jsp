...
<nav class="col-md-2 bg-light sidebar">
    <div class="sidebar-sticky">
        <ul class="nav menu flex-column">
            <li class="nav-item">
                <a class="nav-link" href="admin?command=users">
                    <svg width="26px" height="26px" class="bi bi-people" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <fmt:message key="admin_user_user_management"/></svg>
                    </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="admin?command=tariffs">
                    ...
                    <fmt:message key="admin_tariffs"/></a>
            </li>
        </ul>
    </div>
</nav> <!-- left menu END. -->

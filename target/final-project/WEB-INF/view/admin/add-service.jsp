...
<%@ page import="com.mischenkov.controller.admin.AddServiceCommand" %>
<c:set var="CURRENT_LANGS" value="<%=ContextVariable.CONTEXT_CURRENT_LANGS%>"/>
<c:set var="REQ_ATR_PATTERN_ERROR_MSG" value="<%=AddServiceCommand.REQ_ATR_PATTERN_ERROR_MSG%>"/>
...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <main class="col-md-9 ml-sm-auto col-lg-10 px-4 main"> <!-- site content -->
            ...
            <form class="row" action="admin?command=addService" method="POST">
                <div class="col-3">
